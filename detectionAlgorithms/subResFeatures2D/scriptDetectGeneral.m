...
%% movie information
movieParam.imageDir = 'C:\kjData\Rosen\130121\Titrations\0920\'; %directory where images are
movieParam.filenameBase = '250nM nckWT a_'; %image file name base
...
detectionParam.alphaLocMax = 0.005; %alpha-value for initial detection of local maxima
