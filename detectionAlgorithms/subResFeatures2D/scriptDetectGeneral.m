...
%% movie information
movieParam.imageDir = '/home/kj35/files/LCCB/receptors/superres/fromJohn/movie2/imagesCropped1/'; %directory where images are
movieParam.filenameBase = 'crop_Results3_'; %image file name base
movieParam.firstImageNum = 101; %number of first image in movie
movieParam.lastImageNum = 4920; %number of last image in movie
...
%% save results
saveResults.dir = '/home/kj35/files/LCCB/receptors/superres/fromJohn/movie2/analysisCropped1/'; %directory where to save input and output
