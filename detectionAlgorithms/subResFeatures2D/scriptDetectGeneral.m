...
%% movie information
movieParam.imageDir = '/home/kj35/tmpData/Martin/2010_10_19_WT/WT1_1/images/'; %directory where images are
movieParam.filenameBase = 'WT1_1_D3D_'; %image file name base
...
saveResults.filename = 'detectionIllustrate.mat'; %name of file where input and output are saved
% saveResults = 0;
