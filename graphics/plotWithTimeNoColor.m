function plotWithTimeNoColor(trackedFeatureInfo,timeRange,newFigure)
%PLOTWITHTIMENoCOLOR plots a group of tracks and allows user to click on them and extract track information
%
%SYNOPSIS plotWithTimeNoColor(trackedFeatureInfo)
%
...
if nargin < 1
    disp('--plotWithTimeNoColor: Incorrect number of input arguments!');
    return
end
