function varargout = obsoleteuTrackPackageGUI(varargin)
% OBSOLETEUTRACKPACKAGEGUI M-file for obsoleteuTrackPackageGUI.fig
%      OBSOLETEUTRACKPACKAGEGUI, by itself, creates a new OBSOLETEUTRACKPACKAGEGUI or raises the existing
%      singleton*.
%
%      H = OBSOLETEUTRACKPACKAGEGUI returns the handle to a new OBSOLETEUTRACKPACKAGEGUI or the handle to
%      the existing singleton*.
%
%      OBSOLETEUTRACKPACKAGEGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OBSOLETEUTRACKPACKAGEGUI.M with the given input arguments.
%
%      OBSOLETEUTRACKPACKAGEGUI('Property','Value',...) creates a new OBSOLETEUTRACKPACKAGEGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before obsoleteuTrackPackageGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to obsoleteuTrackPackageGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help obsoleteuTrackPackageGUI

% Last Modified by GUIDE v2.5 13-May-2011 11:37:20

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @obsoleteuTrackPackageGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @obsoleteuTrackPackageGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before obsoleteuTrackPackageGUI is made visible.
function obsoleteuTrackPackageGUI_OpeningFcn(hObject, eventdata, handles, varargin)
%
% obsoleteuTrackPackageGUI(MD)   MD: MovieData object
%
% Useful tools
%
% User Data:
...
function varargout = obsoleteuTrackPackageGUI_OutputFcn(hObject, eventdata, handles) 
