function varargout = obsoleteThresholdProcessGUI(varargin)
% OBSOLETETHRESHOLDPROCESSGUI M-file for obsoleteThresholdProcessGUI.fig
%      OBSOLETETHRESHOLDPROCESSGUI, by itself, creates a new OBSOLETETHRESHOLDPROCESSGUI or raises the existing
%      singleton*.
%
%      H = OBSOLETETHRESHOLDPROCESSGUI returns the handle to a new OBSOLETETHRESHOLDPROCESSGUI or the handle to
%      the existing singleton*.
%
%      OBSOLETETHRESHOLDPROCESSGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in OBSOLETETHRESHOLDPROCESSGUI.M with the given input arguments.
%
%      OBSOLETETHRESHOLDPROCESSGUI('Property','Value',...) creates a new OBSOLETETHRESHOLDPROCESSGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before obsoleteThresholdProcessGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to obsoleteThresholdProcessGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help obsoleteThresholdProcessGUI

% Last Modified by GUIDE v2.5 23-Apr-2011 11:56:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @obsoleteThresholdProcessGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @obsoleteThresholdProcessGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before obsoleteThresholdProcessGUI is made visible.
function obsoleteThresholdProcessGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% userData.set1Fig = obsoleteThresholdProcessGUI('mainFig', handles.figure1, procID);
%
% Available tools 
% UserData data:
...
% Choose default command line output for obsoleteThresholdProcessGUI
...
function varargout = obsoleteThresholdProcessGUI_OutputFcn(hObject, eventdata, handles) 
