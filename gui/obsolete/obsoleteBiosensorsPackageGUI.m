function varargout = obsoleteBiosensorsPackageGUI(varargin)
% obsoleteBiosensorsPackageGUI M-file for obsoleteBiosensorsPackageGUI.fig
%      obsoleteBiosensorsPackageGUI, by itself, creates a new obsoleteBiosensorsPackageGUI or raises the existing
%      singleton*.
%
%      H = obsoleteBiosensorsPackageGUI returns the handle to a new obsoleteBiosensorsPackageGUI or the handle to
%      the existing singleton*.
%
%      obsoleteBiosensorsPackageGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in obsoleteBiosensorsPackageGUI.M with the given input arguments.
%
%      obsoleteBiosensorsPackageGUI('Property','Value',...) creates a new obsoleteBiosensorsPackageGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before obsoleteBiosensorsPackageGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to obsoleteBiosensorsPackageGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help obsoleteBiosensorsPackageGUI

% Last Modified by GUIDE v2.5 13-May-2011 11:44:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @obsoleteBiosensorsPackageGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @obsoleteBiosensorsPackageGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before obsoleteBiosensorsPackageGUI is made visible.
function obsoleteBiosensorsPackageGUI_OpeningFcn(hObject, eventdata, handles, varargin)
%
% obsoleteBiosensorsPackageGUI(MD)   MD: MovieData object
%
% Useful tools
%
% User Data:
...
% UIWAIT makes obsoleteBiosensorsPackageGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = obsoleteBiosensorsPackageGUI_OutputFcn(hObject, eventdata, handles) 
