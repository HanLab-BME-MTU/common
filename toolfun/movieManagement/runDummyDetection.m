function runDummyDetection(movieData,varargin)
% runDummyDetection imports detection results into the dummy process
%
...
iProc = movieData.getProcessIndex('DummyDetectionProcess',1,0);

%If the process doesn't exist, create it
if isempty(iProc)
    iProc = numel(movieData.processes_)+1;
    movieData.addProcess(DummyDetectionProcess(movieData,...
...
for  i = p.ChannelIndex;
    ...
    copyfile(p.InputData{i}, outFilePaths{1,i});
end
