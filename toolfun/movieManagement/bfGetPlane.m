...
%
%    iPlane - the index of the plane(s) to be retrieved from the dataset.
%
% Output
%
%    I - an array of size (width x height x nPlanes) containing the planes
%
...
ip.addRequired('iPlane',@isvector);
ip.parse(r,iPlane);

% Works for single series for now
r.setSeries(0);
