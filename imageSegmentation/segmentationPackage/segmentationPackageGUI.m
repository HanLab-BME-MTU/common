...
% SEGMENTATIONPACKAGEGUI M-file for segmentationPackageGUI.fig
%      SEGMENTATIONPACKAGEGUI, by itself, creates a new SEGMENTATIONPACKAGEGUI or raises the existing
%      singleton*.
%
%      H = SEGMENTATIONPACKAGEGUI returns the handle to a new SEGMENTATIONPACKAGEGUI or the handle to
%      the existing singleton*.
%
%      SEGMENTATIONPACKAGEGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SEGMENTATIONPACKAGEGUI.M with the given input arguments.
%
%      SEGMENTATIONPACKAGEGUI('Property','Value',...) creates a new SEGMENTATIONPACKAGEGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before segmentationPackageGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to segmentationPackageGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help segmentationPackageGUI

% Last Modified by GUIDE v2.5 17-Nov-2010 14:24:28

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segmentationPackageGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @segmentationPackageGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before segmentationPackageGUI is made visible.
function segmentationPackageGUI_OpeningFcn(hObject, eventdata, handles, varargin)
%
...
function varargout = segmentationPackageGUI_OutputFcn(hObject, eventdata, handles) 
