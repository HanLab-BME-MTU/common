function varargout = segmentProcessGUI(varargin)
%SEGMENTPROCESSGUI M-file for segmentProcessGUI.fig
%      SEGMENTPROCESSGUI, by itself, creates a new SEGMENTPROCESSGUI or raises the existing
%      singleton*.
%
%      H = SEGMENTPROCESSGUI returns the handle to a new SEGMENTPROCESSGUI or the handle to
%      the existing singleton*.
%
%      SEGMENTPROCESSGUI('Property','Value',...) creates a new SEGMENTPROCESSGUI using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to segmentProcessGUI_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      SEGMENTPROCESSGUI('CALLBACK') and SEGMENTPROCESSGUI('CALLBACK',hObject,...) call the
%      local function named CALLBACK in SEGMENTPROCESSGUI.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help segmentProcessGUI

% Last Modified by GUIDE v2.5 18-Nov-2010 17:01:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @segmentProcessGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @segmentProcessGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before segmentProcessGUI is made visible.
function segmentProcessGUI_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = segmentProcessGUI_OutputFcn(hObject, eventdata, handles)
