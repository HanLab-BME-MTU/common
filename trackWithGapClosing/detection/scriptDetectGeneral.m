...
%% movie information
movieParam.imageDir = '/mnt/sickkids/Hiro/071229_many/blebbistatin/100microMolar/bleb100_03/images/'; %directory where images are
...
% saveResults.filename = 'detection_Qdot_0.mat'; %name of file where input and output are saved
saveResults = 0;
