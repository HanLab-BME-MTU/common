...
%movie information
movieParam.imageDir = '/mnt/sickkids/Hiro/070820Cy3Titration/20000_60_6/images/'; %directory where images are
...
saveResults.filename = 'detectionFinal3.mat'; %name of file where input and output are saved
% saveResults = 0;
...
%saveResults
saveResults.dir = '/mnt/sickkids/Hiro/070820Cy3Titration/20000_60_8/analysis/mmf/'; %directory where to save input and output
saveResults.filename = 'tracksFromDetectionFinal3_4.mat'; %name of file where input and output are saved
% saveResults = 0;
