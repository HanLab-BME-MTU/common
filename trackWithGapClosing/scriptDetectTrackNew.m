...
%movie information
movieParam.imageDir = 'U:\trialStuff\Chang\cdr2-pom1_M1\images\'; %directory where images are
movieParam.filenameBase = 'cdr2-pom1_M1_'; %image file name base
movieParam.firstImageNum = 1; %number of first image in movie
movieParam.lastImageNum = 25; %number of last image in movie
...
%save results
saveResults.dir = 'U:\trialStuff\Chang\cdr2-pom1_M1\analysis\'; %directory where to save input and output
saveResults.filename = 'detection_cdr2-pom1_M1_5.mat'; %name of file where input and output are saved
% saveResults = 0;
...
costMatParam.minSearchRadiusL = 1; %minimum allowed search radius (in pixels). The search radius is calculated on the spot in the code given a feature's motion parameters. If it happens to be smaller than this minimum, it will be increased to the minimum.
costMatParam.maxSearchRadiusL = 3; %maximum allowed search radius (in pixels). Again, if a feature's calculated search radius is larger than this maximum, it will be reduced to this maximum.
...
%previous step
costMatParam.minSearchRadiusCG = 1; %minimum allowed search radius (in pixels).
costMatParam.maxSearchRadiusCG = 3; %maximum allowed search radius (in pixels).
...
%saveResults
saveResults.dir = 'U:\trialStuff\Chang\cdr2-pom1_M2\analysis\'; %directory where to save input and output
saveResults.filename = 'tracks_cdr2-pom1_M2_5_4.mat'; %name of file where input and output are saved
% saveResults = 0;
