...
%movie information
movieParam.imageDir = '/mnt/sickkids/Hiro/070820Cy3Titration/20000_60_8/images/'; %directory where images are
movieParam.filenameBase = '070817Cy3Fab36_'; %image file name base
movieParam.firstImageNum = 1; %number of first image in movie
movieParam.lastImageNum = 246; %number of last image in movie
...
%save results
saveResults.dir = '/mnt/sickkids/Hiro/070820Cy3Titration/20000_60_8/analysis/mmf/'; %directory where to save input and output
saveResults.filename = 'detection_0914_1.mat'; %name of file where input and output are saved
% saveResults = 0;
...
gapCloseParam.minTrackLen = 5; %minimum length of tracks from linking to be used in gap closing.
...
costMatParam.minSearchRadiusL = 6; %minimum allowed search radius (in pixels). The search radius is calculated on the spot in the code given a feature's motion parameters. If it happens to be smaller than this minimum, it will be increased to the minimum.
...
%previous step
costMatParam.minSearchRadiusCG = 6; %minimum allowed search radius (in pixels).
...
costMatParam.maxAngleVV = 10; %maximum angle between the directions of motion of two tracks that allows linking them (and thus closing a gap). Think of it as the equivalent of a searchRadius but for angles.
...
costMatParam.ampRatioLimitCG = [0.5 2]; %for merging and splitting. Minimum and maximum ratios between the intensity of a feature after merging/before splitting and the sum the intensities of the 2 features that merge/split.
...
%saveResults
saveResults.dir = '/mnt/sickkids/Hiro/070820Cy3Titration/20000_60_6/analysis/mmf/'; %directory where to save input and output
saveResults.filename = 'tracks_detection_0914_1_4.mat'; %name of file where input and output are saved
% saveResults = 0;
