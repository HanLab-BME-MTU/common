...
%movieParam
movieParam.imageDir = '/mnt/sickkids/Hiro/070817Cy3Control/C3con3/images/'; %directory where images are
movieParam.filenameBase = '070725QdC3CLNB_'; %image file name base
movieParam.firstImageNum = 1; %number of first image in movie
movieParam.lastImageNum = 592; %number of last image in movie
...
saveResults.filename = 'detectionNew.mat'; %name of file where input and output are saved
% saveResults = 0;
