...
%movieInfo locations
movieInfoDir = {'/orchestra/groups/lccb-receptors/Hiro/091208Cy3CD36jasp/expo2/con16/'};

%movieInfo file names
movieInfoFile = {'detection1.mat'};

%directory for saving results
saveResDir = {'/orchestra/groups/lccb-receptors/Hiro/091208Cy3CD36jasp/expo2/con16/'};


%% calculate number of movies
numMovies = length(movieInfoFile);
...
for iMovie = 1 : numMovies
    ...
    try
        ...
        saveResults.filename = 'tracks1Detection1.mat'; %name of file where input and output are saved
