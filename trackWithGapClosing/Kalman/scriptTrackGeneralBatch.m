...
for iMovie = 1 : numMovies1
    ...
    try
        ...
        %optional input
        parameters.diagnostics = [289]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
