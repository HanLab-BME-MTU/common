...
%movieInfo locations
movieInfoDir = {...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_48/analysis/',...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_49/analysis/',...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_50/analysis/',...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_51/analysis/',...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_52/analysis/',...
    '/home/kj35/tmpData/Martin2/2010_07_28_WT/2010_07_28_53/analysis/',...
    };

%movieInfo file names
movieInfoFile = {...
    'detectionAllMod5.mat',...
    'detectionAllMod5.mat',...
    'detectionAllMod5.mat',...
    'detectionAllMod5.mat',...
    'detectionAllMod5.mat',...
...
for iMovie = 1 : numMovies1
    ...
    try
        ...
        parameters.minSearchRadius = 0.5; %minimum allowed search radius. The search radius is calculated on the spot in the code given a feature's motion parameters. If it happens to be smaller than this minimum, it will be increased to the minimum.
        ...
        %optional input
        parameters.diagnostics = [40]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
        ...
        saveResults.filename = 'tracksAll4.mat'; %name of file where input and output are saved
