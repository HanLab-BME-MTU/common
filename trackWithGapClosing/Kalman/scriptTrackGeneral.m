...
%optional input
parameters.diagnostics = [399]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
parameters.minSearchRadius = 4; %minimum allowed search radius.
...
% parameters.timeReachConfL = 6; %similar to timeReachConfB, but for the linear part of the motion.
...
%saveResults
% saveResults.dir = '/home/kj35/files/LCCB/receptors/endoCells/AnindyaChanda/20110812/Unstimulated/Cell_8/Analysis/UTrackPackage/Sub_Resolution_Detection/'; %directory where to save input and output
% saveResults.filename = 'tracksTest6.mat'; %name of file where input and output are saved
