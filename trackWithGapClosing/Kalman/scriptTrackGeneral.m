...
%optional input
parameters.diagnostics = [1150]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
% saveResults.filename = 'tracks1DetectionNew.mat'; %name of file where input and output are saved
