...
% saveResults.filename = 'tracks1DetectionNew_Frames0001to0600.mat';
% [tracksFinal01,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(movieInfo(1:600),...
%     costMatrices,gapCloseParam,kalmanFunctions,probDim,saveResults,verbose);
% 
% saveResults.filename = 'tracks1Detection1_Frames0601to1200.mat';
% [tracksFinal02,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(movieInfo(601:1200),...
%     costMatrices,gapCloseParam,kalmanFunctions,probDim,saveResults,verbose);
% 
% saveResults.filename = 'tracks1Detection1_Frames1201to1800.mat';
