...
%saveResults
saveResults.dir = '/home/kj35/files/LCCB/receptors/Galbraiths/data/alphaVandCellEdge/110114/Cs3_CHO03/Cs3_CHO03B/analysisAlphaV/new/tracks/'; %directory where to save input and output
% saveResults.filename = 'tracks1Detection10.mat'; %name of file where input and output are saved
...
for i = 1 : 5
    movieInfoTmp((i-1)*1200+1:min(i*1200,6800)) = movieInfo((i-1)*1200+1:min(i*1200,6800));
