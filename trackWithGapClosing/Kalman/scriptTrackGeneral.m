...
%optional input
parameters.diagnostics = [1450]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
%saveResults
saveResults.dir = '/orchestra/groups/lccb-receptors/endoCells/AnindyaChanda/20100513/10_8/100ms/Area1/Analysis/'; %directory where to save input and output
saveResults.filename = 'tracks10-8_100_Area1__Frames1to800_2.mat'; %name of file where input and output are saved
...
[tracksFinal,kalmanInfoLink,errFlag] = trackCloseGapsKalmanSparse(movieInfo(1:800),...
