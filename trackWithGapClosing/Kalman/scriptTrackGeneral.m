...
%optional input
parameters.diagnostics = [2 98]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
parameters.resLimit = 5; %resolution limit, which is generally equal to 3 * point spread function sigma.
...
saveResults.filename = 'tracks9Detection2_100216_afterBugFix.mat'; %name of file where input and output are saved
