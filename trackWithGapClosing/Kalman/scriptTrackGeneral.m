...
parameters.kalmanInitParam.initVelocity = 3*orientVec; %Kalman filter initialization parameters.

%optional input
parameters.diagnostics = [98]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
%saveResults
saveResults.dir = '/home/kj35/orchestra/groups/lccb-receptors/Martin/KJWildTypeHyphae/WT1/analysis/'; %directory where to save input and output
saveResults.filename = 'tracks22Detection21.mat'; %name of file where input and output are saved
