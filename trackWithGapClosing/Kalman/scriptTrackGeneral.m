...
%optional input
parameters.diagnostics = [499]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
%saveResults
saveResults.dir = '/home/kj35/tmpData/CD36/2010-12-07_CTxB_Export/MbCD_cov01/MbCD_movie32/analysis/'; %directory where to save input and output
saveResults.filename = 'tracks1DetectionAll1.mat'; %name of file where input and output are saved
