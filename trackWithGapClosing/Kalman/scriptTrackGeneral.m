...
%optional input
parameters.diagnostics = [2 90]; %if you want to plot the histogram of linking distances up to certain frames, indicate their numbers; 0 or empty otherwise. Does not work for the first or last frame of a movie.
...
%saveResults
% saveResults.dir = '/home/kj35/orchestra_groups/lccb-receptors/Galbraiths/data/alphaV/091012_CHO03hi_mEosAV_2400_25/analysis/'; %directory where to save input and output
% saveResults.filename = 'tracks2Detection1Frames1801to2400.mat'; %name of file where input and output are saved
