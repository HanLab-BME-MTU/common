...
%   
    ...
    elseif ( ~isnan(segmentSetIN(segID,3)) && ~isnan(segmentSetIN(segID,4)) )
        ...
        if ( (child1Size + child2Size ~= parentSize) ||... 
            ...
            [segmentSetOUT,notRepIntSizeErr] = repairSizeFromIntensity_c(child1ID,segmentSetIN,0,notRepIntSizeErr,intensityInfo);
            ...
            if ( (child1Size_rev + child2Size ~= parentSize) ||... 
                ...
                if ( segmentSetIN(child2ID,3)~= segmentSetIN(child1ID,3))
                    [segmentSetOUT,notRepIntSizeErr] = repairSizeFromIntensity_c(child2ID,segmentSetOUT,0,notRepIntSizeErr,intensityInfo);
                end
                            ...
                            if ( (tempChild1Chk == 1) && (tempChild2Chk == 1) )
                                if ((child1Size_rev == 1) || (child2Size_rev == 1))
                                    ...
                                    [segmentSetOUT,notRepIntSizeErr] =...
                                        repairSizeFromIntensity_c(smallerChildID,segmentSetOUT,0,...
                            ...
                            if (~isnan(segmentSetOUT(child1ID,3)) && ~isnan(segmentSetOUT(child2ID,3)) )
                                ...
                                if (segmentSetOUT(parentID,8) ~= parentSize)
                                    ...
                                    if (segmentSetOUT(parentID,10) == 1)
                                        ...
                                        [segmentSetOUT,notRepIntSizeErr] =...
                                            repairSizeFromIntensity_c(segmentSetOUT(parentID,1),segmentSetOUT,0,...
                                            notRepIntSizeErr,intensityInfo);
                                ...
                                if ((tempChild1Chk == 1) &&...
                                    ...
                                    [segmentSetOUT,notRepIntSizeErr] =...
                                        repairSizeFromIntensity_c(child1ID,segmentSetOUT,0,...
                                        notRepIntSizeErr,intensityInfo);
                                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                                end   
                                if ((tempChild2Chk == 1) &&...
                                    ...
                                    [segmentSetOUT,notRepIntSizeErr] =...
                                        repairSizeFromIntensity_c(child2ID,segmentSetOUT,0,...
                                        notRepIntSizeErr,intensityInfo);
                                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                                end                                  
        ...
        elseif (checkAll && (child1Size + child2Size == parentSize))
            ...
            [segmentSetOUT,notRepIntSizeErr] = repairSizeFromIntensity_c(segmentSetIN(segID,3),...
                segmentSetIN,1,notRepIntSizeErr,intensityInfo);
            %Continue on with child 2
            [segmentSetOUT,notRepIntSizeErr] = repairSizeFromIntensity_c(segmentSetOUT(segID,4),...
                segmentSetIN,1,notRepIntSizeErr,intensityInfo);            
        else
            %No problem found.
            %{
    ...
    elseif (~isnan(segmentSetIN(segID,3)) && ~isnan(segmentSetIN(segID,6)) )
        ...
        if ( (childSize ~= parent1Size + parent2Size) ||...
            ...
            [segmentSetOUT,notRepIntSizeErr] = repairSizeFromIntensity_c(childID,segmentSetIN,0,notRepIntSizeErr,intensityInfo);
                        ...
                        if (tempChildChk ~= 1)
                            ...
                            elseif (childSize_rev == 1)
                                ...
                                %if (segmentSetOUT(childID,8) ~= childSize_rev)
                                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                                    [segmentSetOUT,notRepIntSizeErr] =...
                                        repairSizeFromIntensity_c(childID,segmentSetOUT,0,...
                                        notRepIntSizeErr,intensityInfo);
                                    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
                                %end                                   
                            end
                        ...
                        if (isnan(segmentSetIN(childID,3)))
                            ...
                            if ( ((parent1Size == 1) || (parent2Size == 1)) )
                                ...
                                if (isnan(segmentSetOUT(smallerParentID(1),10)))
                                    ...
                                    %Recall for parent with its parent
                                    [segmentSetOUT,notRepIntSizeErr] =...
                                        repairSizeFromIntensity_c(segmentSetOUT(smallerParentID(1),1),segmentSetOUT,0,...
                                        notRepIntSizeErr,intensityInfo);
                                else
