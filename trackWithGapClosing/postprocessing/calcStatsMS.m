function [msStats,msTimeInfo,mergesInfo,splitsInfo] = calcStatsMS(tracks,minTrackLen,probDim)
%MSSTATS calculate some merge/split statistics
%
%SYNOPSIS [msStats,msTimeInfo,mergesInfo,splitsInfo] = calcStatsMS(tracks,minTrackLen,probDim)
%
