...
%   
%   genpathSVN by Francois Aguet - Same functionality as genpath, but excludes invisible directories
%------------------------------------------------------------------------------
...
for i=1:length(dirs)
   ...
   if (~strcmp(dirname,'.')           && ...
      ...
      p = [p genpathSVN(fullfile(d,dirname))]; % recursive calling of this function.
   end
end
