...
%Because zeiss puts extra, non-delimited info at the END of the file, in
%only one column, we do this stupid workaround of reading the second column
%first to get the number of localizations (using matlabs suggested method
%of reading all as strings and then converting is SLOW)
