function dFdXc = dLSegment2D_dFdXc(xRange, yRange, xC, yC, A, sigmaPSF, l, theta)
% Partial derivative of a 2-dimensional diffraction-limited degment
% function in function of xC.
% dFdXc = dLSegment2D_dFdXc(xRange, yRange, xC, xC, A, sigmaPSF, l, theta);
%
% parameters:
...
%
% output:
% dFdXc is a NxM matrix where N = numel(xRange) and M = numel(yRange).
%
