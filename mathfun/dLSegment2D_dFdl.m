function dFdl = dLSegment2D_dFdl(xRange, yRange, xC, yC, A, sigmaPSF, l, theta)
% Partial derivative of a 2-dimensional diffraction-limited degment
% function in function of l.
% dFdl = dLSegment2D_dFdl(xRange, yRange, xC, xC, A, sigmaPSF, l, theta);
%
% parameters:
...
%
% output:
% dFdl is a NxM matrix where N = numel(xRange) and M = numel(yRange).
%
