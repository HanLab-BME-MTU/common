function F = dLSegment3D(X, Y, Z, xC, yC, zC, A, Bg, sigmaPSF, l, theta1, theta2)
% Diffraction-limited Segment Model
% F = dLSegment3D(X, Y, Z, xC, yC, zC, A, Bg, sigmaPSF, l, theta1, theta2)
%
% parameters:
...
F = Bg + c * exp(-(X.^2 + Y.^2 + Z.^2 - (Z * ct1 + st1 * ...
