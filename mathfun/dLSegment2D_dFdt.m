function dFdt = dLSegment2D_dFdt(xRange, yRange, xC, yC, A, sigmaPSF, l, theta)
% Partial derivative of a 2-dimensional diffraction-limited degment
% function in function of theta.
% dFdt = dLSegment2D_dFdt(xRange, yRange, xC, xC, A, sigmaPSF, l, theta);
%
% parameters:
...
%
% output:
% dFdt is a NxM matrix where N = numel(xRange) and M = numel(yRange).
%
