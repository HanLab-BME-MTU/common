function dFds = dLSegment2D_dFds(xRange, yRange, xC, yC, A, sigmaPSF, l, theta)
% Partial derivative of a 2-dimensional diffraction-limited degment
% function in function of sigmaPSF.
% dFds = dLSegment2D_dFds(xRange, yRange, xC, xC, A, sigmaPSF, l, theta);
%
% parameters:
...
%
% output:
% dFds is a NxM matrix where N = numel(xRange) and M = numel(yRange).
%
