...
%     SM_orientation(sub2ind(img_size,Y1_close,X1_close)) ...
...
whole_ROI = imdilate(SM_current_seg,ones(radius,radius)) + imdilate(MT_current_seg,ones(radius,radius))>0;
% 
