...
%          
%          MT_tip_orientation = MD.processes_{indexFilamentSegmentationProcess}.loadChannelOutput(1,iFrame+0,'output','tip_orientation');
%          MT_RGB_seg_orient_heat_map = MD.processes_{indexFilamentSegmentationProcess}.loadChannelOutput(1,iFrame+0,'output','RGB_seg_orient_heat_map');
%         
