function current_seg = single_file_filament_segmentation(filename, varargin)
% Created 01 2014 by Liya Ding, Matlab R2011b

% input single file name, with the segmentation options to get segmentation
