function varargout = correlationBootstrappingProcessGUI(varargin)
% correlationBootstrappingProcessGUI M-file for correlationBootstrappingProcessGUI.fig
%      correlationBootstrappingProcessGUI, by itself, creates a new correlationBootstrappingProcessGUI or raises the existing
%      singleton*.
%
%      H = correlationBootstrappingProcessGUI returns the handle to a new correlationBootstrappingProcessGUI or the handle to
%      the existing singleton*.
%
%      correlationBootstrappingProcessGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in correlationBootstrappingProcessGUI.M with the given input arguments.
%
%      correlationBootstrappingProcessGUI('Property','Value',...) creates a new correlationBootstrappingProcessGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before correlationBootstrappingProcessGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to correlationBootstrappingProcessGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help correlationBootstrappingProcessGUI

% Last Modified by GUIDE v2.5 02-Nov-2011 17:09:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @correlationBootstrappingProcessGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @correlationBootstrappingProcessGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before correlationBootstrappingProcessGUI is made visible.
function correlationBootstrappingProcessGUI_OpeningFcn(hObject,eventdata,handles,varargin)
...
% Choose default command line output for correlationBootstrappingProcessGUI
...
function varargout = correlationBootstrappingProcessGUI_OutputFcn(~, ~, handles) 
